...
| 文档解析模块 | `local_course_agent/parser.py`、`mineru_api.py` | PDF/Markdown/TXT/DOCX/图片解析，优先 MinerU，失败降级 |
...
| 大模型模块 | `local_course_agent/llm.py` | 调用 OpenAI-compatible LLM 接口，支持文本、图片内容块和流式生成 |
