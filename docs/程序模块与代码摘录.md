...
| RAG 检索模块 | `local_course_agent/retrieval/rag/` | 标题感知切块、BM25/RRF/vector hybrid 检索、引用来源、摘要和练习题 fallback |
...
| 文件型记忆模块 | `local_course_agent/store/` | 保存聊天记录、课程记忆、笔记和学习计划 |
...
来源：`local_course_agent/retrieval/rag/knowledge_base.py`
