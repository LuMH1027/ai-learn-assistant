...
from local_course_agent.learning.mastery.builders import create_mastery_record, create_mistake_record
...
from local_course_agent.learning.mastery.policy import clamp_score, mastery_level, now_text, review_suggestion, score_delta
    ...
    return {
        "mastery": {
            **current,
            ...
            "streak": current["streak"] + 1 if correct else 0,
